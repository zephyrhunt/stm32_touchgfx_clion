...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(timeTask, TImeTask, osPriorityNormal, 0, 512);
  timeTaskHandle = osThreadCreate(osThread(timeTask), NULL);

  /* definition and creation of touchGFXTask */
  osThreadDef(touchGFXTask, TouchGFX_Task, osPriorityNormal, 0, 512);
...
__weak void TImeTask(void const * argument)
{
